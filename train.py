...
def main(save_path, args):
    ...
    print('train sample size:', len(train_dataset), 'val sample size:', len(val_dataset), 'batch:', args.batch_size)
    ...
    for epoch in range(args.epoch):
        ...
        if np.mean(mDice) > best_dice:
            ...
            print("save best model at", save_path + "best_model.pth")
